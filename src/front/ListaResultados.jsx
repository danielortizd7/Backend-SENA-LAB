                                  ...
                                  <TableContainer component={Paper} variant="outlined">
                                    <Table size="small">
                                      ...
                                      <TableBody>
                                        ...
                                        ) : cambio.cambiosRealizados.verificacion ? (
                                          <TableRow>
                                            <TableCell>Estado</TableCell>
                                            <TableCell>{cambio.cambiosRealizados.estado.anterior}</TableCell>
                                            <TableCell>{cambio.cambiosRealizados.estado.nuevo}</TableCell>
                                            <TableCell>-</TableCell>
                                          </TableRow>
                                        ) : null}
                                      </TableBody>
