...
const generarReportePDF = async (req, res) => {
  try {
    ...
    const { cedulaCliente, firmaCliente, cedulaLaboratorista, firmaLaboratorista } = muestra.firmas;

    const rutaPDF = await generarPDF(muestra, cedulaCliente, firmaCliente, cedulaLaboratorista, firmaLaboratorista);
